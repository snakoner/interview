...
11. Что такое контекст в Go?
	...
	6. context.WithValue(parent, key, value) - Позволяет передавать данные через контекст.
		...
		```
12. Как ООП в Go?
    1. Наследования нет - есть встраивание структур в структуры и интерфейсов в интерфейсы.
    2. Инкапсуляция - изоляция полей структур - видны только в пакете, при импорте из других пакетов поля структуры не видны.
    3. Полиморфизм - интерфейсы, generics.
